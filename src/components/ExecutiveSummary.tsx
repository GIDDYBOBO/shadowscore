...
export const ExecutiveSummary: React.FC<ExecutiveSummaryProps> = ({ wallet, isConnected }) => {
  ...
  return (
    <div className="glass-card rounded-2xl p-4 sm:p-5 relative overflow-hidden mb-5 border border-dark-border/80 shadow-glow-card font-sans">
      ...
      <div className="absolute top-0 right-1/4 w-72 h-24 bg-brand-cyan/10 rounded-full blur-2xl pointer-events-none" />
      <div className="absolute bottom-0 left-10 w-48 h-20 bg-brand-blue/10 rounded-full blur-xl pointer-events-none" />

      <div className="flex flex-col lg:flex-row items-center justify-between gap-4 sm:gap-5 relative z-10">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-0.5 text-[11px]">
              <div className="flex items-center space-x-1 text-slate-300 font-medium">
                ...
                <span>Health: <strong className="text-white">{wallet.healthFactor || 2.8}</strong></span>
              </div>
              <div className="flex items-center space-x-1 text-slate-300 font-medium">
                <ShieldCheck className="w-3.5 h-3.5 text-brand-cyan shrink-0" />
                <span>Txns: <strong className="text-white">{wallet.totalTransactions}</strong></span>
              </div>
              <div className="flex items-center space-x-1 text-slate-300 font-medium">
        ...
        <div className="flex items-center space-x-2.5 sm:space-x-3 shrink-0 bg-dark-900/90 p-2.5 sm:p-3 rounded-xl border border-dark-border shadow-md">
          {/* Reputation Score Pill */}
          <div className="px-2.5 sm:px-3 py-0.5 border-r border-dark-border text-center">
            <div className="text-[10px] text-slate-400 font-medium mb-0.5">Reputation</div>
          ...
          {/* Risk Level Pill */}
          <div className="px-2.5 sm:px-3 py-0.5 border-r border-dark-border text-center">
            <div className="text-[10px] text-slate-400 font-medium mb-0.5">Risk Level</div>
          ...
          <div className="px-2.5 sm:px-3 py-0.5 text-center font-mono">
            ...
            <span className="text-[10px] text-slate-400 font-medium font-sans block">
              {isConnected ? 'Live Web3' : 'Unconnected'}
            </span>
          </div>
        </div>
      </div>
