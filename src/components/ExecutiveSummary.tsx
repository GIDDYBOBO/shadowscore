...
export const ExecutiveSummary: React.FC<ExecutiveSummaryProps> = ({ wallet, isConnected }) => {
  ...
  return (
    <div className="glass-card rounded-xl p-3 sm:p-4 relative overflow-hidden mb-4 border border-dark-border/80 shadow-glow-card font-sans">
      {/* Background Radial Glow */}
      <div className="absolute top-0 right-1/4 w-60 h-20 bg-brand-cyan/10 rounded-full blur-2xl pointer-events-none" />
      <div className="absolute bottom-0 left-10 w-40 h-16 bg-brand-blue/10 rounded-full blur-xl pointer-events-none" />

      <div className="flex flex-col lg:flex-row items-center justify-between gap-3.5 relative z-10">
        ...
        <div className="flex items-start space-x-3 flex-1">
          ...
          <div className="space-y-1">
            <div className="flex flex-wrap items-center gap-2">
              <span className="text-[9px] font-black tracking-wider text-brand-cyan uppercase bg-brand-cyan/15 px-1.5 py-0.2 rounded border border-brand-cyan/30 flex items-center gap-1 font-mono">
                <Sparkles className="w-2 h-2 text-brand-cyan animate-pulse" />
            ...
            <h2 className="text-xs sm:text-sm font-extrabold text-white tracking-tight leading-snug">
              Comprehensive Reputation & Autonomous Risk Telemetry
            </h2>

            <p className="text-[10px] text-slate-300 leading-relaxed max-w-2xl font-normal">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-0.5 text-[10px]">
              ...
              <div className="flex items-center space-x-1 text-slate-300 font-medium">
                <Award className="w-3 h-3 text-brand-purple shrink-0" />
        ...
        <div className="flex items-center space-x-2 shrink-0 bg-dark-900/90 p-2 sm:p-2.5 rounded-xl border border-dark-border shadow-md">
          {/* Reputation Score Pill */}
          <div className="px-2.5 py-0.5 border-r border-dark-border text-center">
            <div className="text-[9px] text-slate-400 font-medium mb-0.5 font-sans">Reputation</div>
            <div className="flex items-baseline justify-center space-x-0.5 font-mono">
              <span className="text-base sm:text-lg font-black text-white">{wallet.score}</span>
          ...
          {/* Risk Level Pill */}
          <div className="px-2.5 py-0.5 border-r border-dark-border text-center">
            <div className="text-[9px] text-slate-400 font-medium mb-0.5 font-sans">Risk Level</div>
          ...
          <div className="px-2.5 py-0.5 text-center font-mono">
            <div className="text-[9px] text-slate-400 font-medium mb-0.5 font-sans">Net Assets</div>
            <div className="text-xs sm:text-sm font-black text-brand-cyan">
